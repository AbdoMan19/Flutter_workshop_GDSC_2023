void main(List<String> args) {
  ...
  filteredNumbers=numbers2.where((element) => element>3).toList();
  ...
  filteredNames=names2.where((element) => element[0]=='A' ).toList();
  //print(filteredNames);
  ...
  filteredNames2=names3.where((element) => element[0]=='A' && element[element.length-1]=='d').toList();
  ...
  firstNumberGreaterThan4=numbers3.firstWhere((element) => element>4);
  ...
  johns=people.where((element) => element['name']=='John').toList();
  //print(johns);
